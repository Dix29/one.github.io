            ...
            <div class="auto-container">
                <div class="row clearfix align-items-center">
                        ...
                        <div class="content_block_5">
                            <div class="content-box">
                                <div class="sec-title">
                                    ...
                                    <h2><?php echo $data['project_title'];?></h2>
                                    <div class="title-shape"></div>
                                </div>
                                <div class="text">
                                    <h4><?php echo $data['project_desc'];?></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 image-column">
                        <figure class="image-box"><img src="admin\past_project_photos\<?php echo $data['photo_1'];?>" alt=""></figure>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 inner-column">
                        <div class="feature-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="admin\past_project_photos\<?php echo $data['photo_2'];?>" alt=""></figure>
                        ...
                        <div class="feature-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="admin\past_project_photos\<?php echo $data['photo_3'];?>" alt=""></figure>
