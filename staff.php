        ...
        <section class="about-style-three" >
            <div class="auto-container">
                <div class="row clearfix align-items-center">
                    <table width="90%"   border="1" class="table-hover table-bordered">
  <tr bgcolor="#006633">
    <td	 class="badge-primary">No.</td>
    <td class="badge-primary">Name</td>
    <td class="badge-primary">Mobile</td>
    <td class="badge-primary">Qualification</td>
    <td class="badge-primary">Photo</td>
   
  </tr>
  <?php
  $no=1;
 $q=mysqli_query($a,"select * from staff_data order by s_id")or die("QF"); 
  ...
  <tr height="100">
    ...
    <td><img src="admin/s_photos/<?php echo $data['photo'];?>" width="95" height="76"></td>
