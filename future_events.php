...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!-- about-style-three -->
		<?php
					$q=mysqli_query($a,"select * from future_event order by u_id")or die("QF"); 
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 content-column">
                        <div class="content_block_5">
                            <div class="content-box">
                                ...
                                <div class="text">
                                    <h3><strong>Description : </strong><?php echo $data['description'];?></h3>
									 <h3><strong>Date : </strong><?php echo $data['date'];?></h3>
                                     <h3><strong>Time : </strong><?php echo $data['time'];?></h3>
                                     <h3><strong>Chief Guest :</strong><?php echo $data['chief_guest'];?></h3>
