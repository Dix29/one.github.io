...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <section class="place-section sec-pad pb-140">
            <div class="vector-image" style="background-image: url(assets/images/shape/shape-11.png);"></div>
            <div class="auto-container">
				...
				<?php
					$qg=mysqli_query($a,"select * from video_gallery order by v_id desc")or die ("QF");
                                ...
                                <ul class="accordion-box">
                                    <li class="accordion block active-block">
                                        <div class="acc-btn active">
                                            ...
                                            <h5><?php echo $datag['v_title'];?></h5>
                                        </div>
                                        <div class="acc-content current">
                                            <div class="text">
                                                <h5><?php echo $datag['description'];?> </h5>
