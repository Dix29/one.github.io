...
{
	extract($_POST);
	$q=mysqli_query($a,"insert into country(name) values('$nm')")or die("QF");
    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
           ...
           <div class="form-group">
            <label for="input-1">Country Name</label>
            <input name="nm" type="text" class="form-control" id="nm-1" placeholder="Enter Your Country" >
           </div>
