...
{
	extract($_POST);
	$q=mysqli_query($a,"insert into state (co_id,sname) values('$cnm','$snm')")or die("QF");
 	header("location:view_states.php");
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card-body">
           ...
           <div class="form-group">
            <label for="input-1">Enter State Name</label>
            <input name="snm" type="text" class="form-control" id="nm-1" placeholder="Enter Your State" >
           </div>
