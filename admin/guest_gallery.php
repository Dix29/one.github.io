...
if(isset($_REQUEST['Submit']))
{
	...
	$q=mysqli_query($a,"insert into guest_photo(g_title,g_photo)values('$nm','$fn1')")or die("QF");
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
           ...
           <p><b><a href="view_guest_gallery.php">View Guest Gallery</a></p></b>
        ...
        <div class="card-body">
           ...
           <div class="form-group">
            <label for="input-1">Guest Name</label>
