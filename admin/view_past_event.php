            ...
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <tbody>
				  <?php
				$no=1;
				$q=mysqli_query($a,"select * from past_event")or die("QF");
				...
				?>
                  <tr>
                    ...
                    <td><?php echo $data['event_time'];?></td>
					 <td> <img src="pe_photos/<?php echo $data['photo_1'];?>" width="50" height="50"></td>
					 <td><img src="pe_photos/<?php echo $data['photo_2'];?>" width="50" height="50"></td>
					 <td><img src="pe_photos/<?php echo $data['photo_3'];?>" width="50" height="50"></td>
					 <td><?php echo $data['video'];?></td>
					 <td><a href="delete_past_events.php?d=<?php echo $data['c_id'];?>" onClick="return f1();">Delete</a></td>
				 </tr>
				  <?php
				  $no++;
				  }
