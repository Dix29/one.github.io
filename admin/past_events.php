...
if(isset($_REQUEST['Submit']))
{
	...
	$q=mysqli_query($a,"insert into past_event(event_title,event_date,event_time,photo_1,photo_2,photo_3,video)values('$nm','$ed','$et','$fn1','$fn2','$fn3','$vd')")or die("QF");
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
           ...
           <p><b><a href="view_past_event.php">View Event</a></p></b>
        ...
        <div class="card-body">
           ...
           <div class="form-group">
            ...
            <input name="nm" type="text" class="form-control" id="nm" placeholder="Enter Event Name" onKeyPress="return (event.charCode ==32 || event.charCode > 64 && 
	event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) ">
           </div>
		   
		   <div class="form-group">
            <label for="input-1">Event Date</label>
            <input name="ed" type="date" class="form-control" id="ed">
           </div>
		   
		   <div class="form-group">
            <label for="input-1">Event Time</label>
            <input name="et" type="time" class="form-control" id="et">
           </div>
           <div class="form-group">
            <label for="input-2">Image 1</label>
           <input name="img1" type="file" id="img1" class="form-control">
         
           </div>
           <div class="form-group">
            <label for="input-3">Image 2</label>
            <input name="img2" type="file" id="img2" class="form-control">
			</div>
           <div class="form-group">
            <label for="input-4">Image 3</label>
            <input name="img3" type="file" id="img3" class="form-control">
           </div>
		  
           <div class="form-group">
            <label for="input-5">Video</label>
            <input name="vd" type="text" class="form-control" id="vd" >
           </div>
