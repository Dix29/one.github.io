                ...
                <div class="sortable-masonry">
                    <div class="filters">
                        <ul class="filter-tabs filter-btns centred clearfix">
							...
							<?php
					$qg1=mysqli_query($a,"select p_category from photo_gallery group by p_category")or die ("QF");
					while($datag1=mysqli_fetch_array($qg1))
					{
					?>
                            <li class="filter" data-role="button" data-filter=".<?php echo $datag1['p_category'];?>"><?php echo str_replace("_"," ",$datag1['p_category']);?></li>
                      <?php } ?>      
					...
					{
					?>    
						<div class="col-lg-4 col-md-6 col-sm-`2 masonry-item small-column all <?php echo $datag['p_category'];?>">
                            <div class="portfolio-block-two">
                                <div class="inner-box">
                                    <figure class="image-box"><img src="photo_gallery/<?php echo $datag['photo'];?>" alt=""></figure>
                                    <div class="lower-content">
                                        <h4><?php echo $datag['photo_title'];?><strong></strong></h4>
                                    </div>
                                    <div class="overlay-content">
                                         
                                        <div class="text">
                                             <h4><a href="#"><?php echo $datag['photo_title'];?></a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
