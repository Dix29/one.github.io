...
<body>
  ...
  <tr bgcolor="#006633">
    ...
    <td class="badge-primary">Receipt No	</td>
    <td class="badge-primary">Ammount</td>
    <td class="badge-primary">Description</td>
    <td class="badge-primary">Date</td>
  </tr>
  <?php
  $no=1;
 $q=mysqli_query($a,"select * from donor order by do_id")or die("QF"); 
